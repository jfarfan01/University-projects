...
def task_3():
    ...
    y0 = np.random.normal(loc=0, scale=1)
    print(f'{x0:.4f}, {y0:.4f}')
    ...
    x, y, f_list = gradient_descent(ackley, gradient_ackley, x0, y0, learning_rate=0.1, lr_decay=0.8, num_iters=40)
    ...
    plt.title("Ackley function gradient descent")
    plt.show()
