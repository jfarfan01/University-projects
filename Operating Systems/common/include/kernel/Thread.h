...
class Thread
{
  ...
  public:
    ...
    void setCancelState(size_t state);

    void setCancelType(size_t type);

    size_t getCancelState();

    size_t getCancelType();

    void setExitCalledFlag(bool val);

    bool getExitCalledFlag();
  ...
  private:
    ...
    size_t cancel_state_;

    size_t cancel_type_;

    bool exit_called_flag_;
